...
class OldPixelsPass extends Pass {
	...
	render(renderer, writeBuffer) {
		...
		uniforms.pixelBorders.value = this.pixelBorders;
		...
		return new ShaderMaterial({
			...
			fragmentShader: /* glsl */`
				...
				void main() {
					...
					if (pixelBorders) {
						if ((mod(vUv.x * resolution.x * pixelSize, pixelSize) < 1.0)
							|| (mod(vUv.y * resolution.y * pixelSize, pixelSize) < 1.0)) {
